...
export namespace StrictARIA {
    ...
    export namespace Properties {
        ...
        export type Override = {
            ...
            ariaColCount: `${number | bigint}` | null;
            ariaColIndex: `${number | bigint}` | null;
            ariaColSpan: `${number | bigint}` | null;
            ...
            ariaPosInSet: `${number | bigint}` | null;
            ariaPressed: "true" | "false" | "mixed" | "undefined" | null;
            ariaReadOnly: "true" | "false" | null;
            ariaRequired: "true" | "false" | null;
            ariaRowCount: `${number | bigint}` | null;
            ariaRowIndex: `${number | bigint}` | null;
            ariaRowSpan: `${number | bigint}` | null;
            ariaSelected: "true" | "false" | "undefined" | null;
            ariaSetSize: `${number | bigint}` | null;
            ariaSort: "ascending" | "descending" | "none" | "other" | null;
            ariaValueMax: `${number | bigint}` | null;
            ariaValueMin: `${number | bigint}` | null;
            ariaValueNow: `${number | bigint}` | null;
