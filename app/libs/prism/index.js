/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+js-templates+typescript */
var _self =
	...
	Prism = (function (e) {
		...
		if (
			...
			(i.stringify = function e(n, t) {
				...
				return (
					"<" + i.tag + ' class="' + i.classes.join(" ") + '"' + o + ">" + i.content + "</" + i.tag + ">"
				)
			}),
			!e.document)
		)
